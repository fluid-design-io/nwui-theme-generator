  ...
  return (
    <div
      ...
      style={{
        ...
        "--ios-destructive-foreground": colors.ios[theme].destructiveForeground,
        ...
        "--android-popover-foreground": colors.android[theme].popoverForeground,
        ...
        "--android-primary-foreground": colors.android[theme].primaryForeground,
